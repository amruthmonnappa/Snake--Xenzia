...
cscript //nologo slmgr.vbs /ato | find /i "successfully" && (echo.&echo ============================================================================&echo.&echo #Official Website: http://192.64.115.135&echo.&echo #How it works: http://192.64.115.135/how-to-activate-windows-10-with-cmd&echo.&echo ============================================================================&choice /n /c YN /m "Would you like to visit my blog [Y,N]?" & if errorlevel 2 exit) || (echo The connection to my KMS server failed! Trying to connect to another one... & echo Please wait... & echo. & echo. & set /a i+=1 & goto server)
explorer "http://192.64.115.135"&goto halt
:notsupported
